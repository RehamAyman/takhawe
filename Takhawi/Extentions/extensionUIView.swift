...
extension UIView {
    ...
    func appStypeTextField() {
        ...
        layer.borderColor = AppColors.shared.borderColor
        layer.borderWidth = 1
//        backgroundColor = UIColor(hexString: "#202020")
    }
    func makeSmallRadius() {
        self.layer.cornerRadius = ViewConstants.shared.smallCornerRadius
    }
    ...
    func addDashedBorder() {
        let color = AppColors.shared.borderColor
        print("♥️♥️♥️\(self.frame.size)")
