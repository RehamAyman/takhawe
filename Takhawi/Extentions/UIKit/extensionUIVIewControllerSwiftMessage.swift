...
extension UIViewController {
    ...
    func showMessage(title: String? = nil, sub: String?, type: Theme = .warning, layout: MessageView.Layout = .statusLine, iconText: String) {
        ...
        view.configureContent(title: title ?? "", body: sub ?? "", iconText: iconText)
